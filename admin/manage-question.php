...
$sql="delete from tblquestion where ID=:rid";
...
<head>
    ...
    <title>Online Examination System - Manage Question</title>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="alter_pagination" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
$sql="SELECT tblquestion.ID as qid,tblquestion.PaperID,tblquestion.Question,tblexam.ID as eid,tblexam.ExamName from tblquestion join tblexam on tblexam.ID=tblquestion.PaperID";
$query = $dbh -> prepare($sql);
$query->execute();
